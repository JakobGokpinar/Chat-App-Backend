...
This repository contains the backend code for a messaging application built with PHP and SQL. The backend is responsible for handling user authentication, friend management, messaging, image handling, and more. It connects with the frontend via Ajax and supports email functionalities through SendGrid.
